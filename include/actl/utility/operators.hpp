...
// Inherit from this class to enable ADL lookup to find operators in this
// namespace. Template base class enables empty base class chaining to avoid
// type size increasing, reference:
// https://www.boost.org/doc/libs/1_70_0/libs/utility/operators.htm#old_lib_note
...
template <class... Ts>
using enable_derived_operators =
