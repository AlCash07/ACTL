...
inline std::enable_if_t<
    decltype(serialization_access{}.has_serialize<T, Device&, Format&, Tag...>(0))::value, index>
...
template <class Device, class Format, class T, class... Tag>
inline std::enable_if_t<
    decltype(serialization_access{}.has_deserialize<T, Device&, Format&, Tag...>(0))::value, bool>
