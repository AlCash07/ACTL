...
template<typename Dir, typename OEC, typename IEC>
struct vertex_edges {
    OEC out_edges;
};

template<typename OEC, typename IEC>
...
template<typename V, typename OE, typename S>
struct full_edge {
    V u;
    OE e_out;
    OE e_in;
...
template<typename V, typename OE>
