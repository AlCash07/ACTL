...
inline constexpr orientation2d orientation(const Policy& policy, const point<T0>& lhs,
                                           const point<T1>& rhs) {
...
inline enum orientation orientation(const Policy& policy, const point<T0, N>& lhs,
