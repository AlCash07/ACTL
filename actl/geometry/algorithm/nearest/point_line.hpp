...
inline std::pair<point<N, T0>, point<N, X>> nearest(const nearest_point_line<P, R>& policy,
                                                    const point<N, T0>& point,
                                                    const line<N, T1, K>& line) {
...
inline auto nearest(use_default, const point<N, T0>& point, const line<N, T1, K>& line) {
