...
TEST("is_template_base_of") {
    ASSERT_TRUE(is_template_base_of_v<std::vector, std::vector<double>>);
    ASSERT_TRUE(is_template_base_of_v<std::vector, public_derived>);
    ASSERT_TRUE(is_template_base_of_v<std::vector, private_derived>);
    ASSERT_FALSE(is_template_base_of_v<std::vector, std::pair<int, int>>);
    ASSERT_FALSE(is_template_base_of_v<std::vector, int>);
}
