...
static_assert(ac::equal_same_type(int{2}, ac::to_signed(int{2})));

static_assert(ac::equal_same_type(uint64_t{4}, ac::to_unsigned(int64_t{4})));
// to_unsigned doesn't change an unsigned type
static_assert(ac::equal_same_type(unsigned{2}, ac::to_unsigned(unsigned{2})));
