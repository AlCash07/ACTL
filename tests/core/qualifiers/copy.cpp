...
static_assert(
    std::is_same_v<int const, ac::copy_const_t<int, char const volatile>>
);
...
static_assert(
    std::is_same_v<int const, ac::copy_const_t<int const, char const volatile>>
);
static_assert(std::is_same_v<int, ac::copy_const_t<int const, char const&>>);
static_assert(
    std::is_same_v<int, ac::copy_const_t<int const, char volatile&&>>
);
/* reference target */
static_assert(std::is_same_v<int&, ac::copy_const_t<int&, char>>);
static_assert(
    std::is_same_v<int&, ac::copy_const_t<int&, char const volatile>>
);
static_assert(std::is_same_v<int&, ac::copy_const_t<int&, char const&>>);
static_assert(std::is_same_v<int&, ac::copy_const_t<int&, char volatile&&>>);
...
static_assert(
    std::is_same_v<int volatile, ac::copy_volatile_t<int, char const volatile>>
);
...
static_assert(
    std::is_same_v<int const, ac::copy_volatile_t<int const, char const&>>
);
static_assert(
    std::is_same_v<int const, ac::copy_volatile_t<int const, char volatile&&>>
);
/* reference target */
static_assert(std::is_same_v<int&, ac::copy_volatile_t<int&, char>>);
static_assert(
    std::is_same_v<int&, ac::copy_volatile_t<int&, char const volatile>>
);
static_assert(std::is_same_v<int&, ac::copy_volatile_t<int&, char const&>>);
static_assert(std::is_same_v<int&, ac::copy_volatile_t<int&, char volatile&&>>);
...
static_assert(
    std::is_same_v<int const volatile, ac::copy_cv_t<int, char const volatile>>
);
...
static_assert(
    std::is_same_v<int, ac::copy_reference_t<int, char const volatile>>
);
static_assert(std::is_same_v<int&, ac::copy_reference_t<int, char const&>>);
static_assert(
    std::is_same_v<int&&, ac::copy_reference_t<int, char volatile&&>>
);
/* const target */
...
static_assert(
    std::is_same_v<int const&, ac::copy_reference_t<int const, char const&>>
);
static_assert(std::is_same_v<
              int const&&,
...
static_assert(
    std::is_same_v<int volatile&&, ac::copy_cvref_t<int, char volatile&&>>
);
/* const target */
...
static_assert(
    std::is_same_v<int const&, ac::copy_cvref_t<int const, char const&>>
);
static_assert(
    std::is_same_v<int volatile&&, ac::copy_cvref_t<int const, char volatile&&>>
);
/* reference target */
static_assert(std::is_same_v<int, ac::copy_cvref_t<int&, char>>);
static_assert(std::is_same_v<
